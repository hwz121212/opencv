...
#include "opencv2/gapi/src/streaming/onevpl/accelerators/utils/shared_lock.hpp"
#undef private

#include "opencv2/gapi/src/streaming/onevpl/accelerators/utils/elastic_barrier.hpp"
